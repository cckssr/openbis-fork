...
def openbis_definitions(entity):
    ...
    entities = {
        ...
        "propertyType": {
            "attrs": "code label description managedInternally dataType vocabulary sampleType schema transformation semanticAnnotations registrator registrationDate metaData multiValue".split(),
            "attrs_new": "code label description managedInternally dataType vocabulary sampleType schema transformation metaData multiValue".split(),
