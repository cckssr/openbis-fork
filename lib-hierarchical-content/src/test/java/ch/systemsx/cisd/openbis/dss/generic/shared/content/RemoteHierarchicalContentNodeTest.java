...
public class RemoteHierarchicalContentNodeTest
{
    ...
    public void fixture() throws Exception
    {
        ...
        remoteDss = context.mock(IDssService.class, "remote dss");
            ...
            throws Exception
    {
        ...
        Assert.assertEquals(file.getAbsolutePath(), fileInSessionWorkspace.getAbsolutePath());
    ...
    public void childNodeInfoIsRetrievedFromRemoteDssIfPathInfoDbIsNotAvailable() throws Exception
    {
        ...
        Assert.assertEquals(children.get(0).getRelativePath(), "path/to/file");
