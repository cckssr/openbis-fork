...
public class HDF5ContainerBasedHierarchicalContentNodeTest extends AssertJUnit
{
    ...
    public static void assertH5ExampleContent(IHierarchicalContentNode node)
    {
        ...
        AssertJUnit.assertEquals("3361fd20 24242 PLATE1_A01_01_Cy3.png\n" +
        ...
        AssertJUnit.assertEquals(537641, node.getFileLength());
        AssertJUnit.assertEquals(-2098219814, node.getChecksumCRC32());
    }
    ...
    private void assertH5arExampleContent(IHierarchicalContentNode node)
    {
        ...
        AssertJUnit.assertEquals("e15e2b61 36424 wA1_d1-1_cCy3.png\n" +
