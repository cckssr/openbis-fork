...
public class RemoteHierarchicalContentTest extends AbstractRemoteHierarchicalContentTestCase
{
    ...
    public void testGetDefaultRootNode() throws Exception
    {
        ...
        AssertJUnit.assertEquals(true, rootNode.isDirectory());
        AssertJUnit.assertEquals("", rootNode.getRelativePath());
        AssertJUnit.assertEquals(null, rootNode.getParentRelativePath());
        AssertJUnit.assertEquals("", rootNode.getName());
    ...
    {
        return new RemoteHierarchicalContent(new DatasetLocationNode(AbstractRemoteHierarchicalContentTestCase.DATA_SET_LOCATION),
