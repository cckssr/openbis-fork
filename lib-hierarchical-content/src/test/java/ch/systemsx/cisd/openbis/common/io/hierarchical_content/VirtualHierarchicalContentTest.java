...
public class VirtualHierarchicalContentTest extends AssertJUnit
{
    ...
    public void testFailWithNullOrEmptyComponents()
    {
        ...
        {
            AssertJUnit.assertEquals("Undefined contents", ex.getMessage());
        }
    ...
    public void testEqualsAndHashCode()
    {
        ...
        AssertJUnit.assertEquals(virtualContent, virtualContentSameComponents);
        AssertJUnit.assertEquals(virtualContent.hashCode(), virtualContentSameComponents.hashCode());

        IHierarchicalContent[] subComponents =
        { component1, component2 };
        IHierarchicalContent virtualContentSubComponents = createContent(subComponents);
        AssertJUnit.assertFalse(virtualContent.equals(virtualContentSubComponents));
        AssertJUnit.assertFalse(virtualContent.hashCode() == virtualContentSubComponents.hashCode());
        ...
        AssertJUnit.assertFalse(virtualContent.equals(virtualContentReorderedComponents));
        AssertJUnit.assertFalse(virtualContent.hashCode() == virtualContentReorderedComponents.hashCode());
    ...
    public void testGetRootNode()
    {
        ...
        AssertJUnit.assertSame(virtualRoot, virtualRoot2);
        AssertJUnit.assertSame(mergedNode, virtualRoot);
    ...
    public void testGetNode()
    {
        ...
        AssertJUnit.assertSame(mergedNode, node);
    ...
    public void testListMatchingNodesWithRelativePathPattern()
    {
        ...
        AssertJUnit.assertSame(mergedNodeList, nodeList);
    ...
    public void testSimpleNodeShadowing()
    {
        ...
        AssertJUnit.assertEquals(22L, childNode.getFileLength());

        AssertJUnit.assertEquals(1, childNodes.size());
