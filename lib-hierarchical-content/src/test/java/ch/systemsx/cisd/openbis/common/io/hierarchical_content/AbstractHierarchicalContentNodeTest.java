...
public class AbstractHierarchicalContentNodeTest extends AssertJUnit
{
    ...
    private void assertUnsupportedFileOperationOnAction(IDelegatedAction action)
    {
        ...
        {
            action.execute();
            AssertJUnit.fail("Expected UnsupportedOperationException");
        } catch (UnsupportedOperationException ex)
        {
            AssertJUnit.assertEquals(AbstractHierarchicalContentNode.OPERATION_NOT_SUPPORTED_FOR_A_DIRECTORY,
                    ex.getMessage());
        }
    }
    ...
    private void assertUnsupportedDirectoryOperationOnAction(IDelegatedAction action)
    {
        ...
        {
            AssertJUnit.assertEquals(AbstractHierarchicalContentNode.OPERATION_SUPPORTED_ONLY_FOR_A_DIRECTORY,
                    ex.getMessage());
        }
    }
