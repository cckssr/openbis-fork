...
public class VirtualNodeMergingTest extends AssertJUnit
{
    ...
    public void testCreateEmptyNodeFails()
    {
        ...
        AssertJUnit.assertNull(merger.tryCreateMergedNode());
    ...
    public void testCreateNode()
    {
        ...
        AssertJUnit.assertEquals("VirtualNode [nodes=[node3, node2, node1]]", mergedNode.toString());
    ...
    public void testCreateNodeList()
    {
        ...
        AssertJUnit.assertEquals("[mergedNode1, mergedNode2, mergedNode3, mergedNode4, mergedNode5]",
                mergedNode.toString());
