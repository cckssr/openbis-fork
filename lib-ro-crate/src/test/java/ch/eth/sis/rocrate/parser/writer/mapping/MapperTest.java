package ch.eth.sis.rocrate.parser.writer.mapping;
...
*/
    ...
    public void testObjectWithProperties()
    {
        ...
        assertEquals("openbis-schema:hasNAME", result.getSchema().getProperties().get(0).getId());
        assertTrue(result.getMetaDataEntries().isEmpty());
    ...
    public void testObjectWithPropertiesAndMetaData()
    {
        ...
        assertTrue(metaDataEntry.getProps().containsKey("hasNAME"));
        assertTrue(result.getMappingInfo().getRdfsToObjects().get("openbis-schema:ENTRY1")
                .contains(entryType));
