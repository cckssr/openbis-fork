...
class ExperimentTypeInternalExpectations extends Expectations
{

    public ExperimentTypeInternalExpectations(final IApplicationServerApi api, final boolean exportReferred)
    {
