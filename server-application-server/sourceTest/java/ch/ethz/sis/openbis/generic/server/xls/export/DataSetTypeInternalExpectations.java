...
class DataSetTypeInternalExpectations extends Expectations
{

    public DataSetTypeInternalExpectations(final IApplicationServerApi api, final boolean exportReferred)
    {
