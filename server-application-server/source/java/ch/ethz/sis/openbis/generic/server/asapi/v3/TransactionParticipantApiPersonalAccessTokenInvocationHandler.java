...
public class TransactionParticipantApiPersonalAccessTokenInvocationHandler
        implements ITransactionParticipantApi, ApplicationListener<ApplicationEvent>
{
    ...
    public TransactionParticipantApiPersonalAccessTokenInvocationHandler(final IPersonalAccessTokenInvocation invocation)
    {
    ...
    @Override public void beginTransaction(final UUID transactionId, final String sessionToken, final String interactiveSessionKey,
            final String transactionCoordinatorKeyOrNull)
    {
    ...
    @Override public <T> T executeOperation(final UUID transactionId, final String sessionToken, final String interactiveSessionKey,
            ...
            final Object[] operationArguments) throws TransactionOperationException
    {
