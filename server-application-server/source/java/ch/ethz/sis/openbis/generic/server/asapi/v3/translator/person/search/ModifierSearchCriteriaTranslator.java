 ...
 * @author pkupczyk
 */
public class ModifierSearchCriteriaTranslator extends PersonSearchCriteriaTranslator
{

    public ModifierSearchCriteriaTranslator(IDAOFactory daoFactory, IObjectAttributeProviderFactory entityAttributeProviderFactory)
    {
    ...
    {
        return criteria instanceof ModifierSearchCriteria;
    }
    ...
    protected IAttributeSearchFieldKind getUserIdFieldKind(SearchObjectKind objectKind)
    {
        ...
        {
            case EXPERIMENT:
                return ExperimentAttributeSearchFieldKind.MODIFIER_USER_ID;
            case SAMPLE:
