...
public class TypeGroupSearchManager extends AbstractLocalSearchManager<TypeGroupSearchCriteria, TypeGroup, Long>
{
    public TypeGroupSearchManager(final ISQLSearchDAO searchDAO, final ISQLAuthorisationInformationProviderDAO authProvider,
    ...
    {
        return new TypeGroupSearchCriteria();
    }

    @Override
    protected Set<Long> doFilterIDsByUserRights(final Set<Long> ids, final AuthorisationInformation authorisationInformation)
    {
        // No filtering of type groups is needed.
        return ids;
    }

    @Override
    public Set<Long> searchForIDs(final Long userId, final AuthorisationInformation authorisationInformation, final TypeGroupSearchCriteria criteria,
...
//        return resultBeforeFiltering;
    ...
    @Override
    public List<Long> sortIDs(final Collection<Long> ids, final SortOptions<TypeGroup> sortOptions) {
        return doSortIDs(ids, sortOptions, TableMapper.TYPE_GROUP);
    }
}
