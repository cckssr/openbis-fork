...
@Component
public class DeleteTypeGroupsOperationExecutor extends DeleteObjectsOperationExecutor<ITypeGroupId, TypeGroupDeletionOptions>
        implements
        IDeleteTypeGroupsOperationExecutor
{

    @Autowired
    private IDeleteTypeGroupExecutor executor;

    @Override
    protected Class<? extends DeleteObjectsOperation<ITypeGroupId, TypeGroupDeletionOptions>> getOperationClass()
    {
        return DeleteTypeGroupsOperation.class;
    }

    @Override
    protected DeleteObjectsOperationResult doExecute(IOperationContext context, DeleteObjectsOperation<ITypeGroupId, TypeGroupDeletionOptions> operation)
    {
        executor.delete(context, operation.getObjectIds(), operation.getOptions());
        return new DeleteTypeGroupsOperationResult();
    }
