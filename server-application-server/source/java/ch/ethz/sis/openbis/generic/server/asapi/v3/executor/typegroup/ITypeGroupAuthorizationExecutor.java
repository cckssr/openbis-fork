...
public interface ITypeGroupAuthorizationExecutor extends IObjectAuthorizationExecutor
{
    void canCreate(IOperationContext context, TypeGroupPE typeGroup);

    void canUpdate(IOperationContext context, TypeGroupUpdate update, TypeGroupPE typeGroup);

    void canDelete(IOperationContext context, ITypeGroupId id, TypeGroupPE typeGroup);
