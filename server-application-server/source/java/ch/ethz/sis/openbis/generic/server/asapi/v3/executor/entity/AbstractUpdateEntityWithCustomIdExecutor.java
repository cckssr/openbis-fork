...
import ch.ethz.sis.openbis.generic.server.asapi.v3.helper.common.batch.*;
...
public abstract class AbstractUpdateEntityWithCustomIdExecutor <UPDATE extends IUpdate, PE extends ICustomIdHolder<ID_TYPE>, ID extends IObjectId, PERM_ID, ID_TYPE extends Serializable>
        implements IUpdateEntityExecutor<UPDATE, PERM_ID>
{
    ...
    {
        Collection<ID_TYPE> ids = new HashSet<>();
        ...
        Map<ID_TYPE, PE> idToEntityMap = new HashMap<>();
    ...
    protected abstract List<PE> list(IOperationContext context, Collection<ID_TYPE> ids);
