...
@Component
public class TypeGroupAssignmentAuthorizationExecutor implements ITypeGroupAssignmentAuthorizationExecutor
{
    @Override
    ...
    @Override
    @RolesAllowed(RoleWithHierarchy.INSTANCE_ADMIN)
    @Capability("DELETE_TYPE_GROUP_ASSIGNMENT")
    ...
    @Capability("GET_TYPE_GROUP_ASSIGNMENT")
    ...
    @Override
    @RolesAllowed({ RoleWithHierarchy.PROJECT_OBSERVER, RoleWithHierarchy.SPACE_ETL_SERVER })
    @Capability("SEARCH_TYPE_GROUP_ASSIGNMENT")
