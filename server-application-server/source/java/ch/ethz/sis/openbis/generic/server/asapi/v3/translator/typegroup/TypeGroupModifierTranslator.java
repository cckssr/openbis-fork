...
@Component
public class TypeGroupModifierTranslator extends ObjectToPersonTranslator implements ITypeGroupModifierTranslator
{
    @Override
    protected List<ObjectRelationRecord> loadRecords(LongOpenHashSet objectIds)
    {
        TypeGroupQuery query = QueryTool.getManagedQuery(TypeGroupQuery.class);
        return query.getModifierIds(objectIds);
    }
}
