 ...
 * @author pkupczyk
 */
public interface IVocabularyTermAuthorizationExecutor extends IObjectAuthorizationExecutor
{

    void canCreate(IOperationContext context);

    void canCreateOfficial(IOperationContext context);

    void canCreateUnofficial(IOperationContext context);

    void canUpdate(IOperationContext context, VocabularyTermPE previousTerm, VocabularyTermUpdate update);
