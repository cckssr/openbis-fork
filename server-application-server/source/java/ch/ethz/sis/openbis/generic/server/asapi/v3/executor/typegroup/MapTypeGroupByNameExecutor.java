...
@Component
public class MapTypeGroupByNameExecutor extends AbstractMapObjectByIdExecutor<ITypeGroupId, TypeGroupPE>
        implements IMapTypeGroupByNameExecutor
{
...
//       nothing to do?
    ...
    {
        typeGroupDAO = daoFactory.getTypeGroupDAO();
    }
}
