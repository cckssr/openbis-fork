...
@Component
public class MapTypeGroupAssingmentByIdExecutor extends AbstractMapObjectByIdExecutor<ITypeGroupAssignmentId, SampleTypeTypeGroupsId>
        implements IMapTypeGroupAssingmentByIdExecutor
{
    @Override
    ...
    @Override
    protected void addListers(IOperationContext context,
            List<IListObjectById<? extends ITypeGroupAssignmentId, SampleTypeTypeGroupsId>> listers)
    {
//        listers.add(new ListTypeGroupTechIdByName());
    }
}
