...
public interface ITypeGroupAssignmentAuthorizationExecutor extends IObjectAuthorizationExecutor
{
    void canCreate(IOperationContext context, SampleTypeTypeGroupsPE typeGroupAssignment);

    void canDelete(IOperationContext context, ITypeGroupAssignmentId id, SampleTypeTypeGroupsPE typeGroupAssignment);
