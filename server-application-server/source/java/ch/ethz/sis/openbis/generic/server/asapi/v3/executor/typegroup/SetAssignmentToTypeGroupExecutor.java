...
{
    @Autowired
    private IMapTypeGroupByNameExecutor mapTypeGroupByNameExecutor;
    ...
    @Override
    protected ITypeGroupId getRelatedId(TypeGroupAssignmentCreation creation)
    {
        return creation.getTypeGroupId();
    }

    @Override
    protected Map<ITypeGroupId, TypeGroupPE> map(IOperationContext context, List<ITypeGroupId> relatedIds)
    {
        return mapTypeGroupByNameExecutor.map(context, relatedIds);
    }
    ...
    @Override
    protected void set(IOperationContext context, SampleTypeTypeGroupsPE entity, TypeGroupPE related)
    {
        entity.setTypeGroup(related);
    }
}
