...
public abstract class AbstractCreateEntityWithCustomIdExecutor<CREATION extends ICreation, PE extends ICustomIdHolder<ID_TYPE>, PERM_ID extends IObjectId, ID_TYPE extends Serializable>
        implements ICreateEntityExecutor<CREATION, PERM_ID>
{
    ...
    private void reloadEntities(IOperationContext context, Map<CREATION, PE> creationToEntityMap)
    {
        ...
        Map<Object, PE> idToEntityMap = new HashMap<>();
