...
public class DistributedPackagingDataSetFileOperationsManager extends AbstractDataSetFileOperationsManager implements IDataSetFileOperationsManager
{
            ...
            IOpenBISService service, IDataSetDirectoryProvider directoryProvider, IPackageManager packageManager)
    {
        ...
        if (aDefaultSmallDataSetsFolder != null && !aDefaultSmallDataSetsFolder.trim().isEmpty())
        {
    ...
    public Status markAsDeleted(IDatasetLocation dataset)
    {
        ...
        File folderOfMarkers = new File(archiveFolder, FOLDER_OF_AS_DELETED_MARKED_DATA_SETS);
