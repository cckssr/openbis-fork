...
import ch.systemsx.cisd.common.utilities.FileBasedPause;
...
class MultiDataSetArchivingFinalizer
{
    ...
    public ProcessingStatus process(List<DatasetDescription> datasets, Map<String, String> parameterBindings)
    {
        List<String> dataSetCodes = extracCodes(datasets);
        Status status = Status.OK;
        try
        {
            Parameters parameters = getParameters(parameterBindings);
    ...
    private Parameters getParameters(Map<String, String> parameterBindings)
    {
