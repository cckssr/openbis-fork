...
public class MultiDataSetDeletionMaintenanceTaskTest extends AbstractFileSystemTestCase
{
    ...
    private IDssService dataStoreService;
            ...
            extends MultiDataSetDeletionMaintenanceTask
    {
        ...
        private final IDssService dataStoreService;
        ...
        public MockMultiDataSetDeletionMaintenanceTask(
                ...
                IOpenBISService openBISService,
                IDssService dataStoreService,
                ...
                IFreeSpaceProvider freeSpaceProvider, Properties archiverProperties, IDataSetDirectoryProvider directoryProvider)
        {
        ...
        @Override public IDataSetDirectoryProvider getDirectoryProvider()
        {
    ...
    public void setUpTestEnvironment()
    {
        ...
        dataStoreService = context.mock(IDssService.class);
        ...
        task = new MockMultiDataSetDeletionMaintenanceTask(
                ...
                new MockMultiDataSetFileOperationsManager(properties, directoryProvider,
                        freeSpaceProvider), freeSpaceProvider, properties, directoryProvider);
