...
public class MultiDataSetUnarchivingMaintenanceTaskTest extends AssertJUnit
{
    ...
    private static final class MockMultiDataSetUnarchivingMaintenanceTask extends MultiDataSetUnarchivingMaintenanceTask
    {
        ...
        public void setService(IOpenBISService service)
        {
        ...
        public void setArchiverPlugin(final IArchiverPlugin archiverPlugin)
        {
            this.archiverPlugin = archiverPlugin;
        }

        public void setDirectoryProvider(final IDataSetDirectoryProvider directoryProvider)
        {
    ...
    public void setUpTestEnvironment()
    {
        ...
        maintenanceTask.setArchiverPlugin(archiverPlugin);
        maintenanceTask.setDirectoryProvider(directoryProvider);
