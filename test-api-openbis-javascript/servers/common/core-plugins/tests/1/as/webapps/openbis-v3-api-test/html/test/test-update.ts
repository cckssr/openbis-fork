...
exports.default = new Promise((resolve) => {
    require(["jquery", "underscore", "openbis", "test/common", "test/openbis-execute-operations", "test/dtos"], function (
        ...
        var executeModule = function (moduleName: string, facade: openbis.openbis, dtos: openbis.bundle) {
            ...
            QUnit.test("updateExperiment() change property of type SAMPLE", function (assert) {
                ...
                var fCheck = function (experiment: openbis.Experiment) {
                    ...
                    c.assertEqual(experiment.getProject().getSpace().getCode(), "TEST", "Space code")
                    c.assertEqual(
                        experiment.getSampleProperties()[propertyTypeCode][0].getIdentifier().getIdentifier(),
                        "/PLATONIC/SCREENING-EXAMPLES/PLATE-2",
                        "Sample property"
                    )
                    c.assertEqual(
                        (<openbis.PropertyHistoryEntry>experiment.getHistory()[0]).getPropertyName(),
                        propertyTypeCode,
                        "Previous sample property name"
                    )
                    c.assertEqual(
                        (<openbis.PropertyHistoryEntry>experiment.getHistory()[0]).getPropertyValue(),
                        "20130412140147735-20",
                        "Previous sample property value"
                    )
                }
            ...
            QUnit.test("updateExperiment() change multi-value property of type SAMPLE", function (assert) {
                ...
                var fCheck = function (experiment: openbis.Experiment) {
                    ...
                    var history = experiment.getHistory().filter((x: any) => x.propertyName == propertyTypeCode && x.validTo)
                    c.assertEqual(history.length, 2, "Previous sample property name")
                    c.assertEqual(
                        history
                            .map((x: any) => x.propertyValue)
                            .sort()
                            .toString(),
            ...
            QUnit.test("updateSamples() with annotated parent and child", function (assert) {
                ...
                var fUpdate = function (facade: openbis.openbis, permId) {
                    ...
                    parentRelationShip.removeChildAnnotations(["type"]).addChildAnnotation("color", "blue").addParentAnnotation("color", "yellow")
                    var childRelationShip = update.relationship(childId)
                    childRelationShip.addParentAnnotation("color", "green").removeParentAnnotations(["type"]).addChildAnnotation("color", "black")
                    return facade.updateSamples([update])
                }
                ...
                var fCheck = function (sample: openbis.Sample) {
                    ...
                    c.assertEqualDictionary(
                        parentRelationship.getParentAnnotations(),
                        { type: "father", color: "yellow" },
                        "Parent -> parent annotations"
                    )
            ...
            QUnit.test("updateSamples() change property of type SAMPLE", function (assert) {
                ...
                var fCheck = function (sample: openbis.Sample) {
                    ...
                    c.assertEqual(
                        (<openbis.PropertyHistoryEntry>sample.getHistory()[0]).getPropertyName(),
                        propertyTypeCode,
                        "Previous sample property name"
                    )
                    c.assertEqual(
                        (<openbis.PropertyHistoryEntry>sample.getHistory()[0]).getPropertyValue(),
                        "20130412140147735-20",
                        "Previous sample property value"
                    )
                }
            ...
            QUnit.test("updateSamples() change multi-value property of type SAMPLE", function (assert) {
                ...
                var fCheck = function (sample: openbis.Sample) {
                    ...
                    var history = sample.getHistory().filter((x: any) => x.propertyName == propertyTypeCode && x.validTo)
                    c.assertEqual(history.length, 2, "Previous sample property name")
                    c.assertEqual(
                        history
                            .map((x: any) => x.propertyValue)
            ...
            QUnit.test("updateDataSet() change property of type SAMPLE", function (assert) {
                ...
                var fCheck = function (dataSet: openbis.DataSet) {
                    ...
                    c.assertEqual(
                        (<openbis.PropertyHistoryEntry>dataSet.getHistory()[0]).getPropertyName(),
                        propertyTypeCode,
                        "Previous sample property name"
                    )
                    c.assertEqual(
                        (<openbis.PropertyHistoryEntry>dataSet.getHistory()[0]).getPropertyValue(),
                        "20130412140147735-20",
                        "Previous sample property value"
                    )
            ...
            QUnit.test("updateDataSet() change multi-value property of type SAMPLE", function (assert) {
                ...
                var fCheck = function (dataSet: openbis.DataSet) {
                    ...
                    var history = dataSet.getHistory().filter((x: any) => x.propertyName == propertyTypeCode && x.validTo)
                    c.assertEqual(history.length, 2, "Previous sample property name")
                    c.assertEqual(
                        history
                            .map((x: any) => x.propertyValue)
            ...
            QUnit.test("updatePropertyTypes()", function (assert) {
                ...
                var fCheck = function (propertyType: openbis.PropertyType) {
            ...
            QUnit.test("updateOperationExecutions()", function (assert) {
                ...
                var fCheck = function (execution: openbis.OperationExecution) {
            ...
            QUnit.test("updateQueries()", function (assert) {
                ...
                var fUpdate = function (facade: openbis.openbis, techId) {
                ...
                var fCheck = function (query: openbis.Query) {
                    ...
                    c.assertEqual(
                        ...
                        (<openbis.QueryDatabaseName>update.getDatabaseId().getValue()).getName(),
                        "Database"
                    )
        ...
        resolve(function () {
            ...
            executeModule(
                "Update tests (module ESM - executeOperations)",
