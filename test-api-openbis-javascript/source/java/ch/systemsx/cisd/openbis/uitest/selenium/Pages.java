...
public class Pages
{
    ...
    public <T> T goTo(Location<T> location)
    {
        ...
        {
            String currentUrl = SeleniumTest.driver.getCurrentUrl();
            String targetUrl = ((UrlLocation) location).getUrl();
        ...
        else if (load(TabBar.class).selectTab(location.getTabName()) == false)
        {
            location.moveTo(this);
        }
