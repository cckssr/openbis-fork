...
PARALLEL_UPLOAD_SCRIPT="$BASE_DIR/scripts/obis_modifying_file_upload.sh"
...
export FILE_NAME_DOWNLOADED="test_file.bin.editing"
...
./"$CREATE_FILE_SCRIPT" 3G test_data/test_file.bin
...
echo "=== STEP 4: Run modifying file upload==="
chmod +x "$PARALLEL_UPLOAD_SCRIPT"
./"$PARALLEL_UPLOAD_SCRIPT"

echo "=== STEP 5: Shutdown openBIS ==="
