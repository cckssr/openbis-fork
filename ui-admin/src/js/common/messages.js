...
const keys = {
  ...
  ALL_PAGES: 'ALL_PAGES',
  ALL_PAGES_WITH_LIMIT: 'ALL_PAGES_WITH_LIMIT',
  ALL_PROPERTIES: 'ALL_PROPERTIES',
  APPLY_TO_ALL: 'APPLY_TO_ALL',
  ASCENDING: 'ASCENDING',
  ASSIGNED_TYPE_GROUPS: 'ASSIGNED_TYPE_GROUPS',
  ...
  CONFIRMATION_SELECT_ALL_PAGES_WITH_LIMIT: 'CONFIRMATION_SELECT_ALL_PAGES_WITH_LIMIT',
  CONTAINER: 'CONTAINER',
  CONTENT: 'CONTENT',
  ...
  DATA_IN_THE_ARCHIVE : 'DATA_IN_THE_ARCHIVE',
  DATA_IN_THE_ARCHIVE_CANNOT_BE_DOWNLOADED : 'DATA_IN_THE_ARCHIVE_CANNOT_BE_DOWNLOADED',
  FILES: 'FILES',
  FILTER: 'FILTER',
  FILTERS: 'FILTERS',
  ...
  MANDATORY: 'MANDATORY',
  META_DATA: 'META_DATA',
  META_DATA_IS_INTERNAL: 'META_DATA_IS_INTERNAL',
  META_DATA_CANNOT_BE_CHANGED_OR_REMOVED: 'META_DATA_CANNOT_BE_CHANGED_OR_REMOVED',
  ...
  NEW_OBJECT_TYPE_GROUP: 'NEW_OBJECT_TYPE_GROUP',
  NEW_QUERY: 'NEW_QUERY',
  NEW_USER: 'NEW_USER',
  ...
  NEXT_PAGE: 'NEXT_PAGE',
  NO: 'NO',
  NO_ANNOTATIONS_DEFINED: 'NO_ANNOTATIONS_DEFINED',
  NO_METADATA_DEFINED: 'NO_METADATA_DEFINED',
  ...
  NON_SYSTEM_IMPORT: 'NON_SYSTEM_IMPORT',
  ...
  OBJECT_TYPE_ASSIGNMENT: 'OBJECT_TYPE_ASSIGNMENT',
  OBJECT_TYPE_GROUP_ASSIGNMENTS: 'OBJECT_TYPE_GROUP_ASSIGNMENTS',
  SELECT_OBJECT_TYPE: 'SELECT_OBJECT_TYPE',
  OBJECT_TYPE_GROUP: 'OBJECT_TYPE_GROUP',
  OBJECT_TYPE_GROUPS: 'OBJECT_TYPE_GROUPS',
  OBJECT_TYPE_GROUP_IS_INTERNAL: 'OBJECT_TYPE_GROUP_IS_INTERNAL',
  OBJECT_TYPE_GROUP_ASSIGNMENT_IS_INTERNAL: 'OBJECT_TYPE_GROUP_ASSIGNMENT_IS_INTERNAL',
  OBJECT_TYPE_GROUP_CANNOT_BE_CHANGED_OR_REMOVED: 'OBJECT_TYPE_GROUP_CANNOT_BE_CHANGED_OR_REMOVED',
  OBJECT_TYPE_GROUP_ASSIGNMENT_CANNOT_BE_CHANGED_OR_REMOVED: 'OBJECT_TYPE_GROUP_ASSIGNMENT_CANNOT_BE_CHANGED_OR_REMOVED',
  OBJECT: 'OBJECT',
  OBJECTS: 'OBJECTS',
  OFFICIAL: 'OFFICIAL',
  OFFICIAL_TERM_HINT: 'OFFICIAL_TERM_HINT',
  OFFICIAL_OBJECT_TYPE_HINT: 'OFFICIAL_OBJECT_TYPE_HINT',
  ONLY_FIRST_RESULTS_SHOWN: 'ONLY_FIRST_RESULTS_SHOWN',
  ONTOLOGY_ID: 'ONTOLOGY_ID',
  ONTOLOGY_VERSION: 'ONTOLOGY_VERSION',
  ONTOLOGY_ANNOTATION_ID: 'ONTOLOGY_ANNOTATION_ID',
  OPERATOR: 'OPERATOR',
  ...
  PROPERTY_SEMANTIC_ANNOTATIONS: 'PROPERTY_SEMANTIC_ANNOTATIONS',
  PROPERTY_ASSIGNMENT_SEMANTIC_ANNOTATIONS: 'PROPERTY_ASSIGNMENT_SEMANTIC_ANNOTATIONS',
  ...
  SELECTED_ROWS_LIMIT_REACHED: 'SELECTED_ROWS_LIMIT_REACHED',
...
const messages_en = {
  ...
  [keys.ADD_OBJECT_TYPE]: 'Add Object Type',
  ...
  [keys.CONFIRMATION_SELECT_ALL_PAGES_WITH_LIMIT]: 'Only the first ${0} rows can be selected. Do you want to continue? (this limit can be configured by an administrator)',
  ...
  [keys.DYNAMIC_PROPERTY_PLUGINS]: 'Dynamic scripts',
  [keys.DYNAMIC_PROPERTY_PLUGIN]: 'Dynamic script',
  [keys.EDIT]: 'Edit',
  [keys.EDITABLE]: 'Show in edit views',
  [keys.EMAIL]: 'Email',
  [keys.EMPTY_TRASHCAN]: 'Empty Trashcan',
  [keys.ENTITY]: 'Entity',
  ...
  [keys.ENTITY_VALIDATION_PLUGINS]: 'Validation scripts',
  [keys.ENTITY_VALIDATION_PLUGIN]: 'Validation script',
  [keys.ERROR]: 'Error',
  ...
  [keys.DATA_IN_THE_ARCHIVE]: 'Data in the archive',
  [keys.DATA_IN_THE_ARCHIVE_CANNOT_BE_DOWNLOADED]: 'The requested dataset is archived. Unarchive the dataset to download the data.',
  [keys.FILES]: 'files',
  [keys.FILTER]: 'Filter',
  ...
  [keys.GENERATE_CODES]: 'Auto generated codes',
  ...
  [keys.INTERNAL_PROPERTY]: 'Internal Property',
  [keys.INTERNAL_ASSIGNMENT]: 'Internal Assignment',
  ...
  [keys.META_DATA_IS_INTERNAL]: 'This metadata belong to an internal property or entity type.',
  [keys.META_DATA_CANNOT_BE_CHANGED_OR_REMOVED]: 'This metadata cannot be changed or removed.',
  [keys.MORE]: 'More',
  [keys.MOVE]: 'Move',
  ...
  [keys.NEW_DYNAMIC_PROPERTY_PLUGIN]: 'New Dynamic script',
  [keys.NEW_ENTITY_VALIDATION_PLUGIN]: 'New Validation script',
  [keys.NEW_FOLDER]: 'New Folder',
  [keys.NEW_GROUP]: 'New Group',
  [keys.NEW_OBJECT_TYPE]: 'New Object Type',
  [keys.NEW_OBJECT_TYPE_GROUP]: 'New Object Type Group',
  [keys.NEW_QUERY]: 'New Query',
  [keys.NEW_USER]: 'New User',
  [keys.NEW_VOCABULARY_TYPE]: 'New Vocabulary Type',
  [keys.NEW_SPACE]: 'New Space',
  [keys.NEW_PROJECT]: 'New Project',
  [keys.NEXT_PAGE]: 'Next Page',
  [keys.NO]: 'No',
  [keys.NO_ANNOTATIONS_DEFINED]: 'No annotations defined',
  [keys.NO_METADATA_DEFINED]: 'No metadata defined',
  ...
  [keys.NON_SYSTEM_IMPORT]: 'Internal flag will be skipped during import.',
  ...
  [keys.OBJECT_TYPE_ASSIGNMENT]: 'Object Type Assignment',
  [keys.OBJECT_TYPE_GROUP_ASSIGNMENTS]: 'Object Type Group Assignments',
  [keys.SELECT_OBJECT_TYPE]: 'Select Object Type',
  [keys.OBJECT_TYPE_GROUP]: 'Object Type Group',
  [keys.OBJECT_TYPE_GROUPS]: 'Object Type Groups',
  [keys.OBJECT_TYPE_GROUP_IS_INTERNAL]: 'This is a system internal object type group.',
  [keys.OBJECT_TYPE_GROUP_ASSIGNMENT_IS_INTERNAL]: 'This is a system internal object type group assignment.',
  [keys.OBJECT_TYPE_GROUP_CANNOT_BE_CHANGED_OR_REMOVED]: 'The object type group cannot be changed. The object type group cannot be removed.',
  [keys.OBJECT_TYPE_GROUP_ASSIGNMENT_CANNOT_BE_CHANGED_OR_REMOVED]: 'The object type group assignment cannot be changed. The object type group assignment cannot be removed.',
  [keys.OBJECT]: 'Object',
  ...
  [keys.OFFICIAL_OBJECT_TYPE_HINT]: 'Unofficial (aka ad-hoc) object types can be created by regular users from the non-admin UI. Once verified a object type can be made official by an admin. WARNING: Official object types cannot be made unofficial again.',
  [keys.ONLY_FIRST_RESULTS_SHOWN]: 'Showing only the first ${0} results (${1} results found)',
  [keys.ONTOLOGY_ID]: 'Ontology Id',
  [keys.ONTOLOGY_VERSION]: 'Ontology Version',
  [keys.ONTOLOGY_ANNOTATION_ID]: 'Ontology Annotation Id',
  ...
  [keys.PROPERTY_ASSIGNMENT]: 'Property Assignment',
  [keys.PROPERTY_SEMANTIC_ANNOTATIONS]: 'Property Semantic Annotations',
  [keys.PROPERTY_ASSIGNMENT_SEMANTIC_ANNOTATIONS]: 'Property Assignment Semantic Annotations',
  ...
  [keys.PROPERTY_IS_INTERNAL]: 'Internal property: the property cannot be removed.',
  ...
  [keys.PROPERTY_LABEL]: 'Property label',
  ...
  [keys.REMOVE_OBJECT_TYPE]: 'Remove Object Type',
  ...
  [keys.SELECTED_ROWS_LIMIT_REACHED]: 'Maximum of ${0} rows can be selected.',
  [keys.SEMANTIC_ANNOTATIONS]: 'Semantic Annotations',
  ...
  [keys.VALIDATION_SCRIPT]: 'Validation Script',
  ...
  [keys.VOCABULARY_CODE]: 'Vocabulary code',
