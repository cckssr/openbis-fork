...
const keys = {
  ...
  CONFIRMATION_MERGE_DOWNLOAD:  'CONFIRMATION_MERGE_DOWNLOAD',
...
const messages_en = {
  ...
  [keys.CONFIRMATION_FILE_NAME_CONFLICT]: 'The item named "${0}" already exists in this location. Do you want to replace it with the new file, skip this file and keep the existing one, or cancel the upload?',
