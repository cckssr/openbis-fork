...
const CollapsableSection = ({ children, renderActions = () => false, title, isCollapsed = true, canCollapse = true, renderWarnings }) => {
	...
	return (<>
		<div className={classes.container + ' ' + classes.jc_sb}>
