...
import { ObjectFormController } from '@src/js/components/database/new-forms/controllers/Object/ObjectFormController.ts';
import { CollectionFormController } from '@src/js/components/database/new-forms/controllers/Collection/CollectionFormController.ts';
import { DatasetFormController } from '@src/js/components/database/new-forms/controllers/Dataset/DatasetFormController.ts';
