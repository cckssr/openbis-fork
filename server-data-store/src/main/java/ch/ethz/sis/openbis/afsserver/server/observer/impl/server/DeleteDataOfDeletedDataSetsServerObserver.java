...
public class DeleteDataOfDeletedDataSetsServerObserver implements ServerObserver<TransactionConnection>
{

    private static final Logger logger = LogManager.getLogger(DeleteDataOfDeletedDataSetsServerObserver.class);
