...
public class StandardShareFinderTest extends AbstractIShareFinderTestCase
{
    ...
    public void testMoveFromIncomingToExtension()
    {
        shares =
                Arrays.asList(
                        incomingShare("1", megaBytes(300), 50, Share.ShufflePriority.MOVE_TO_EXTENSION),
                        incomingShare("2", megaBytes(3000), 50, Share.ShufflePriority.SPEED),
    ...
    {
        shares =
                Arrays.asList(incomingShare("1", megaBytes(2000), 50, Share.ShufflePriority.SPEED),
                        incomingShare("2", megaBytes(3000), 50, Share.ShufflePriority.SPEED),
    ...
    public void testShuffleToIncomingShareWithMoreSpace()
    {
        shares =
                Arrays.asList(incomingShare("1", megaBytes(2000), 50, Share.ShufflePriority.SPEED),
                        incomingShare("2", megaBytes(100), 50, Share.ShufflePriority.SPEED));
    ...
    public void testShuffleToIncomingShareWithMoreSpace2()
    {
        shares =
                Arrays.asList(
                        incomingShare("1", megaBytes(2000), 50, Share.ShufflePriority.MOVE_TO_EXTENSION),
                        incomingShare("2", megaBytes(100), 50, Share.ShufflePriority.MOVE_TO_EXTENSION));
        assertShareFoundForDataSet("1", dataSet("2", megaBytes(900), -50));
    }
    ...
    public void testPickExtensionShareWithBestSpeedAndSpaceMatch()
    {
        shares =
                Arrays.asList(
                        incomingShare("1", megaBytes(100), 50, Share.ShufflePriority.MOVE_TO_EXTENSION),
                        incomingShare("2", megaBytes(400), 50, Share.ShufflePriority.MOVE_TO_EXTENSION),
