...
public class TypeGroupAssignmentFetchOptions extends FetchOptions<TypeGroupAssignment> implements Serializable
{
    ...
    @JsonProperty
    private TypeGroupFetchOptions typeGroup;
    ...
    public TypeGroupFetchOptions withTypeGroup()
    {
        if (typeGroup == null)
        {
            typeGroup = new TypeGroupFetchOptions();
        }
        return typeGroup;
    }

    public TypeGroupFetchOptions withTypeGroupUsing(TypeGroupFetchOptions fetchOptions)
    {
        return typeGroup = fetchOptions;
    }
