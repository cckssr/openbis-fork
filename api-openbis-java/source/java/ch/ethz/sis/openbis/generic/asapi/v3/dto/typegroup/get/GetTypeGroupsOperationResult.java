...
public class GetTypeGroupsOperationResult extends GetObjectsOperationResult<ITypeGroupId, TypeGroup>
{

    private static final long serialVersionUID = 1L;

    @SuppressWarnings("unused")
    private GetTypeGroupsOperationResult()
    {
    }

    public GetTypeGroupsOperationResult(Map<ITypeGroupId, TypeGroup> objectMap)
    {
        super(objectMap);
    }
}
