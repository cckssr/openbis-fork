...
import static ch.ethz.sis.openbis.generic.excel.v3.from.utils.PropertyTypeSearcher.getPropertyValue;
...
public class ObjectHelper extends BasicImportHelper
{
    ...
    public void importBlock(List<List<String>> page, int pageIndex, int start, int end)
    {
        ...
        try
        {
            ...
            fetchTypeOptions.withPropertyAssignments().withPropertyType().withVocabulary()
                    .withTerms();
            fetchTypeOptions.withSemanticAnnotations();
            ...
            int line)
    {
        ...
        {
            sample.setSpace(spaceHelper.getSpace(new SpacePermId(space)));
        }
