...
SERVICE_NAME="Atomic File System Server Service"
...
case "$1" in
    ...
    stop)
        ...
        export AFS_HOME="$BASE/../servers/afs-server"
        $AFS_HOME/bin/afs_server.sh stop
        ;;
    ...
    status)
        ...
        PID_FILE="$BASE/../servers/afs-server/afs_server.pid"
    ...
    log)
        ...
        less $BASE/../servers/afs-server/log/afs.log
        ;;
