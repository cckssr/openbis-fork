...
public interface NonModifyingOperationExecutor<E extends Operation> {
    <RESULT> RESULT executeOperation(@NonNull Transaction transaction, @NonNull TransactionFileSystemIO transactionFileSystemIO, @NonNull E operation) throws Exception;
}
