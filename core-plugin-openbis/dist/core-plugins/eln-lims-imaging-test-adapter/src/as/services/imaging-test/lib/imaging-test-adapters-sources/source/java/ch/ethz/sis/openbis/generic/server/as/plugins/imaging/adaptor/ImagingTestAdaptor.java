...
public class ImagingTestAdaptor extends ImagingDataSetAbstractPythonAdaptor
{
    static final String PYTHON_SCRIPT_PROPERTY = "imaging-test.script-path";
    ...
    public ImagingTestAdaptor(Properties properties)
    {
        ...
        if (scriptProperty.trim().isEmpty())
        {
            throw new IllegalArgumentException(
                    "There is no script path property called '" + PYTHON_SCRIPT_PROPERTY + "' defined for this adaptor!");
        }
