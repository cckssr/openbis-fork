...
```java
asExecRuntime files("../core-plugin-openbis/dist/core-plugins/eln-lims-imaging-core/src/as/api-listener/imaging-dataset-interceptor/lib/imaging-dataset-interceptor.jar"),
      files("../core-plugin-openbis/dist/core-plugins/eln-lims-imaging-core/src/as/services/imaging/lib/openBIS-imaging-technology.jar"),
      files("../core-plugin-openbis/dist/core-plugins/eln-lims-imaging-nanonis-adapter/src/as/services/imaging-nanonis/lib/premise-adapters.jar"),
      files("../core-plugin-openbis/dist/core-plugins/eln-lims-imaging-test-adapter/src/as/services/imaging-test/lib/imaging-test-adapters.jar")
