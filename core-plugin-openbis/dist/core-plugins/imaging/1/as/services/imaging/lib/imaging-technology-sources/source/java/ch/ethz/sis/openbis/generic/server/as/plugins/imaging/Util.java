...
public class Util
{
    ...
    {
        return ((ObjectMapper) CommonServiceProvider.getApplicationContext().getBean(ch.ethz.sis.openbis.generic.server.sharedapi.v3.json.ObjectMapperResource.NAME));

//        CommonServiceProvider.getBusinessObjectFactory()
