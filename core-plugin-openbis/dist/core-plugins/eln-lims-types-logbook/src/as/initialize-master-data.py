...
print("======================== eln-lims-types-logbook-master-data xls import ========================")

helper = MasterDataRegistrationHelper(sys.path)
api = CommonServiceProvider.getApplicationContext().getBean(ApplicationServerApi.INTERNAL_SERVICE_NAME)
sessionToken = api.loginAsSystem()

sessionWorkspaceFiles = helper.uploadToAsSessionWorkspace(sessionToken, "eln-types-logbook.xls")
...
print("======================== eln-lims-types-logbook-master-data xls ingestion result ========================")
