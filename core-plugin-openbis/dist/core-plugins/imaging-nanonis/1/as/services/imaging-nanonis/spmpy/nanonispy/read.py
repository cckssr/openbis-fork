...
from .constants import nanonis_end_tags, nanonis_format_dict
...
def _parse_3ds_header(header_raw, header_override):
    ...
    header_entries = header_raw.splitlines()
...
def _parse_sxm_header(header_raw):
    ...
    entries_to_be_dict = [":DATA_INFO:", ":Z-CONTROLLER:", ":Multipass-Config:"]
