...
var JupyterUtil = new function() {
	...
	this.createJupyterNotebookContent = function(dataSets, ownerEntity, fileName) {
		...
		content.push(this.getCodeCell([
		                     ...
		                     "props={'" + profile.getInternalNamespacePrefix() + "name': resultDatasetName, 'notes': resultDatasetNotes, '" + profile.getInternalNamespacePrefix() + "history_id' : resultDatasetHistoryId })\n",
		                     "ds_new.save()"
		]));
