...
def exportResearchCollection(context, params):
    ...
    resultUrl = sendToDSpace(params=params, tempZipFileName=exportZipFileName, tempZipFilePath=exportZipFilePath)
...
def sendToDSpace(params, tempZipFileName, tempZipFilePath):
    ...
    try:
        ...
        httpClient = authenticateUserJava(depositUrl)
...
def authenticateUserJava(url):
    jettyVersion = Jetty.VERSION
    OPERATION_LOG.info('Detected Jetty VERSION: %s' % jettyVersion)
