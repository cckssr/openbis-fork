...
from ro_crate.api import importRoCrate, statusRoCrateImport, getRoCrateUrl
...
def process(context, params):
    ...
    if method == "importRoCrate":
        return importRoCrate(context, params)
    elif method == "statusRoCrateImport":
        return statusRoCrateImport(context, params)
