...
public class PsiExcel2Json
{
    ...
    public void testPsiCrate() throws JsonProcessingException
    {
        ...
        List<String> publicationCodes = List.of("scicat:scicatUser", "scicat:relatedPublications",
                "scicat:numberOfFiles",
                "scicat:sizeOfArchive");
        ...
        assertEquals("0", entity.getProperties().get("scicat:numberOfFiles").toString());
        assertTrue("0", entity.getProperties().get("scicat:relatedPublications").toString()
                .contains("Miettinen"));
        assertEquals("schlepuetz_c", entity.getProperties().get("scicat:scicatUser").toString());
        assertEquals("0", entity.getProperties().get("scicat:sizeOfArchive").toString());
