...
import ch.ethz.sis.shared.log.standard.handlers.NullHandler;
import ch.ethz.sis.shared.log.standard.handlers.PatternFormatter;
import ch.ethz.sis.shared.log.standard.handlers.SingleFileHandler;
...
public class LogInitializer
{
    ...
    private static Level tryGetLogLevel(String levelStr)
    {
        ...
        try
        {
            ch.ethz.sis.shared.log.standard.core.Level
                    log4jLevel = ch.ethz.sis.shared.log.standard.core.Level.parse(levelStr);
