...
public final class LoggingContextHandler
{
    ...
    private final Supplier<String> remoteHostProvider;

    public LoggingContextHandler(Supplier<String> remoteHostProvider)
    {
    ...
    public final void setMDC(String contextID)
    {
        ...
        String remoteHost = remoteHostProvider.get();
        if (context == null)
        {
