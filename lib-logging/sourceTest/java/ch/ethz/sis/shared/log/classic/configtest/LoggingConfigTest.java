...
//        Logger access   = Logger.getLogger("ACCESS");
        ...
        final ch.ethz.sis.shared.log.classic.impl.Logger
                auth = LogFactory.getLogger(LogCategory.AUTH,
                LoggingConfigTest.class);

        final ch.ethz.sis.shared.log.classic.impl.Logger tracking = LogFactory.getLogger(LogCategory.TRACKING,
                LoggingConfigTest.class);

        final ch.ethz.sis.shared.log.classic.impl.Logger access = LogFactory.getLogger(LogCategory.ACCESS,
                LoggingConfigTest.class);
