...
public class BufferedAppenderTest
{
    ...
    public void test()
    {
        // Given
        BufferedAppender
                appender = new BufferedAppender(new TestFormatter(), org.apache.log4j.Level.FINE,
                null);
...
//                "abcdef", "my-thread", null, "ndc", new LocationInfo(null, null), null));
    ...
    {
        BufferedAppender appender = new BufferedAppender(new TestFormatter(), org.apache.log4j.Level.FINE, null,
                maxBufferSize);
