...
public abstract class BaseRuntimeExceptionTemplate<REASON extends Serializable, TYPE extends Enum>
{
    ...
    public BaseRuntimeExceptionTemplate(int componentCode, Class clazz, List<TYPE> types,
            int exceptionCode, String messageTemplate)
    {
    ...
    public RuntimeException getInstance(Object... args)
    {
        ...
        try
        {
            ...
            exception =
                    (RuntimeException) constructor.newInstance(args[0], getThrowableReason(args));
        } catch (Exception e)
        {
