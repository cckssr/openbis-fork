...
![](img/201012-more-dropdown-show-identtification-info.png)


![](img/201012-default-barcode.png)
...
![](img/201012-custom-barcode-update.png)
...
menu under **Utilities**, in the **Tools** tab.

![](img/201012-barcode-generator.png)
...
It is possible to scan barcodes and QR codes using the scan button
...
![](img/201012-scan-barcode-button-menu.png)
