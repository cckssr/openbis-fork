...
![image](img/201012-inventory-menu-multigroup.png)


In the lab notebook, each group member has a personal *Space* where the name is the group prefix and the username of the user.

![image](img/201012-labnotebook-menu-multigroup.png)
...
The Settings can be access from the main menu, under **Utilities** in the **Tools** tab.

![image info](img/201012-group-settings-selection.png)

The General ELN Settings are Settings that are not specific to any of
the defined groups group.
...
2.  **Non Group Settings**. These settings affect all general *Spaces* that
...
![image info](img/201012-multigroup-general-settings.png)

 

Spaces that do not belong to any group do not have a group prefix. 
In the example below **Default** and **Default Lab Notebook** do not belong to any group in the
Lab Notebook.

![image info](img/201012-labnotebook-menu-multigroup.png)
