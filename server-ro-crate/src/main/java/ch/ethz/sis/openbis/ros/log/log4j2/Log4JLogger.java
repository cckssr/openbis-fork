...
class Log4JLogger extends Logger implements ch.ethz.sis.openbis.ros.log.Logger
{
...
//        this.logger.setUseParentHandlers(false);
     ...
     */
    public static ch.ethz.sis.openbis.ros.log.Logger getLog4JLogger(String name) {
        return new Log4JLogger(name);
    }

    public static ch.ethz.sis.openbis.ros.log.Logger getLog4JLogger(Class<?> clazz) {
